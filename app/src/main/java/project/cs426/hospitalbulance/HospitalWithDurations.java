...
public class HospitalWithDurations {
    ...
    private ArrayList<HospitalTime> hospitalTimes = new ArrayList<>() ; //in second
    public HospitalWithDurations(String startID, HospitalTimesCallback callback)
    {
                            ...
                            public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                                if (response.isSuccessful() && response.body() != null) {
                                    ...
                                    if (directionsResponse.routes != null && !directionsResponse.routes.isEmpty()) {
                                        ...
                                        hospitalTimes.add(new HospitalTime(hospitalsMapID,  leg.duration.value));
                                        ...
                                        if(hospitalTimes.size() == num) {
                                            callback.onHospitalTimesReady(hospitalTimes);
                                        }
                                    } else {
    ...
    public ArrayList<HospitalTime> getHospitalTimes()
    {
